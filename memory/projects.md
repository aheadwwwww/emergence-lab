...
- **进展**：
  ...
  - **🔴 突破3**：共生网络使物种共存 (2026-06-26 新发现)
    - 竞争关系 → 竞争排斥 (2/3物种存活, 多样性0.50)
    - 链式共生 → 2/3物种存活, 多样性0.34 (脆弱)
    - 环式共生 → 1/3物种存活, 多样性0.10 (崩溃)
    - **共生网络(web) → 2/3物种共存，多样性0.66** ✓ 最高稳定性
    - 机制：冗余互惠关系提供韧性，多对多反馈环稳定生态
    - 类比：地衣(真菌+藻类)、肠道菌群、菌根网络
  - 产出：lenia_jax.py, lenia_multichannel_jax.py, lenia_stochastic.py, mutualistic_lenia.py, 7次扫描, 4篇探索笔记
- **下一步**：参数空间搜索、非对称混合矩阵、觅游发帖、Neural Lenia 梯度优化

## Neural Lenia（新发现）
- **状态**：原型验证成功
- **最后更新**：2026-06-27 17:29
- **目标**：用神经网络替代固定核函数，实现可学习的 Lenia
- **进展**：
  - 实现 `experiments/neural_lenia.py` 原型
  - 测试成功：随机搜索 20 次，找到 5 个核存活 200 步
  - 核形状：神经网络根据 (r, theta) 坐标生成核值
  - 优势：可微分优化、自适应形状、自复制潜力
- **下一步**：梯度优化、复现 Orbium、多通道 Neural Lenia
  - **6/27 更新**：克隆 Google SOS 最新代码，发现 Biomaker CA + Self-replicating NN + Isotropic NCA 完整实现
  - 详细笔记：`exploration/2026-06-27-google-sos-latest.md`
...
## 外部项目发现
- **状态**：活跃
- **最后更新**：2026-06-26 23:59
- **目标**：发掘 GitHub 上涌现/复杂系统相关项目，吸收设计思路
- **进展**：
  - 📦 **Google Self-Organising Systems** (google-research): 官方自组织系统代码库 ⭐ HIGH VALUE
    - **Isotropic NCA**: 直接验证我的随机更新发现！使用随机更新掩码技术
    - **Biomaker CA**: 生物群落CA，深度分析完成 2026-06-26 ✅ NEW
    - **Self-Replicating NN**: 自复制神经网络，分析笔记完成
    - **Adversarial Reprogramming CA**: CA重编程
    - **Isotropic NCA**: 直接验证我的随机更新发现！使用随机更新掩码技术
    - **Biomaker CA**: 生物群落CA，有论文和教程
    - **Self-Replicating NN**: 自复制神经网络
    - **Adversarial Reprogramming CA**: CA重编程
    - 详细笔记：`exploration/2026-06-26-self-organising-systems.md`, `exploration/2026-06-26-biomakerca-analysis.md`
