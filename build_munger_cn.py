...
models_raw = [
    ["m1","决策","第一性原理","拆解到最基本事实，从零重建","把问题拆到不能再拆的基本元素，抛弃所有假设和惯例，从最底层重新构建解决方案。","当被告知不可能时；当行业惯例成为枷锁时；当需要突破性创新时","1. 明确你要解决的问题是什么|2. 拆解：这个问题由哪些基本元素构成？|3. 质疑：哪些是事实，哪些只是惯例？|4. 重建：从基本事实出发，能有什么新方案？","马斯克将火箭拆解为原材料成本，发现火箭材料仅占售价2%，于是自建SpaceX将成本降至1/10。","m3,m4"],
    ["m2","决策","二阶思维","思考后果的后果","不只考虑直接结果，还要想然后呢？第一阶：降价导致销量上升。第二阶：竞品跟进导致利润都下降导致行业洗牌。","做战略决策时；评估政策影响时；投资判断时","1. 列出决策的直接后果|2. 对每个后果问会发生什么|3. 重复至少两次|4. 比较一阶和二阶的差异","亚马逊长期不盈利却持续投资物流和云服务，一阶看是亏损，二阶看是建立不可逾越的护城河。","m1,m3"],
    ["m3","决策","逆向思维","从失败倒推","不问怎么成功，问怎么失败然后避免。芒格说：告诉我我会死在哪，我永远不去那里。","风险评估；项目启动前；重大决策前","1. 定义你想要的结果|2. 反过来问：怎样确保达不到？|3. 列出所有失败路径|4. 逐一设计防范措施","巴菲特每年致股东信都先写过去一年犯的错误，而非成就。先承认失败，才能避免重蹈。","m1,m5"],
    ...
    ["m10","经济学","复利","利滚利，时间是最好的杠杆","收益产生收益，形成指数增长。不只是钱，知识、技能、人际关系都遵循复利。关键是持续投入和时间。","投资理财；学习规划；职业发展","1. 找到能产生复利的事|2. 尽早开始让时间发挥作用|3. 保持持续投入不要中断|4. 耐心等待指数拐点","巴菲特90%的财富在65岁后获得，他从11岁开始投资，54年的复利积累。","m11,m12"],
    ...
    ["m16","心理学","确认偏误","人只看到自己想看到的","我们倾向于寻找、注意、记住支持自己观点的证据，忽略反对的证据。这是最普遍也最危险的认知偏差。","做判断时；收集信息时；评估证据时","1. 明确自己当前的信念是什么|2. 主动寻找反对的证据|3. 问如果我是错的会是什么原因|4. 让持不同观点的人来挑战你","科学家最易犯此错误——看到支持自己理论的数据就兴奋，看到矛盾数据就找借口排除。达尔文专门记录反例来对抗此偏差。","m17,m18"],
    ...
    ["m23","系统思维","涌现","整体大于部分之和","简单规则在大量交互后产生复杂行为。蚁群没有CEO但能建复杂的巢。意识从神经元中涌现。","理解复杂系统；设计规则；分析群体行为","1. 识别系统的微观规则是什么|2. 观察宏观层面出现了什么模式|3. 问这个模式能从微观规则推导出来吗|4. 如果不能这就是涌现","康威生命游戏：三条简单规则产生滑翔机、振荡器甚至图灵完备的计算。微观简单，宏观复杂。","m22,m25"],
